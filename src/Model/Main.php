...
{
    /**
     * @var \Triangle\WebAnalyzer\Model\Browser $browser Information about the browser
     */
    public $browser;

    /**
     * @var \Triangle\WebAnalyzer\Model\Engine $engine Information about the rendering engine
     */
    public $engine;

    /**
     * @var \Triangle\WebAnalyzer\Model\Os $os Information about the operating system
     */
    public $os;

    /**
     * @var \Triangle\WebAnalyzer\Model\Device $device Information about the device
     */
    public $device;
